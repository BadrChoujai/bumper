...
const DEFAULT_POLICY = {
  ...
  rules: [
    ...
    },
    {
      ...
      secret_name: "real (live) Stripe secret key",
      consequence: "If this file is ever visible in the browser or pushed to a public repo, someone could use it to charge your account.",
    },
    {
      id: "aws-access-key",
      ...
      decision: "ask",
      category: "secret-write",
      secret_name: "real AWS access key",
      consequence: "If this ships to the browser or a public repo, someone could run up charges on your AWS account.",
    },
    {
      ...
      secret_detail: "it bypasses all your security rules",
      consequence: "If it ends up somewhere the browser can see, anyone could read or delete your entire database.",
    },
    ...
    // ---- secrets: beyond Stripe/AWS/Supabase above ----
    {
      ...
      decision: "ask",
      category: "secret-write",
      secret_name: "real GitHub access token",
      consequence: "If it ends up in a public repo, someone could use it as you.",
    },
    {
      id: "google-api-key",
      ...
      decision: "ask",
      category: "secret-write",
      secret_name: "real Google API key",
      consequence: "If it ships to the browser or a public repo, someone could run up charges on your account.",
    },
    {
      id: "slack-token",
      ...
      decision: "ask",
      category: "secret-write",
      secret_name: "real Slack token",
      consequence: "If it leaks, someone could read or post in your workspace as you.",
    },
    {
      ...
      decision: "ask",
      category: "secret-write",
      secret_name: "real private key",
      consequence: "Anyone who gets it can impersonate whatever it authenticates.",
    },
    {
      id: "env-file-write",
      match: { file: "*.env" },
